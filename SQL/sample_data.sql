-- =====================
-- SAMPLE DATA FOR CMPE 138 TEAM6
-- =====================
...
VALUES
    ('111-22-3333', 'John Doe',        35, 80.5, '408-555-1000', 15,5,1990,'123 Main St',  'San Jose', 'CA', '95112', 1),  
    ('222-33-4444', 'Jane Smith',      29, 62.3, '408-555-2000',3,11,1995,'456 Oak Ave',  'San Jose', 'CA', '95113', 3),   

    ('333-44-5555', 'Michael Brown',   42, 90.0, '408-555-3000',
     22,   1, 1983,
     '789 Pine Rd',  'Santa Clara', 'CA', '95050',
     1),

    ('444-55-6666', 'Emily Davis',     8,  28.0, '408-555-4000',
     9,   7, 2017,
     '321 Maple Dr', 'Santa Clara', 'CA', '95051',
     3);


INSERT INTO Patient_Healthcare_Insurance (patient_ssn, patient_name, policy_id)
VALUES
...
-- ========= Manages (Inventory_manager–Medication, M:N) =========
...
-- ========= Medication_dispensed (Prescription–Dispenser, M:N) =========
...
-- ========= Contains (Prescription–Medication, M:N) =========
